...
const Navbar = () => {
  ...
  const { isLoggedIn, name, backendUrl, setIsLoggedIn, setUserData, verified } =
      ...
      <nav className="flex justify-between items-center px-4 py-3 md:px-40">
        ...
        {isLoggedIn ? (
          <div className="flex items-center gap-3 relative">
            ...
            />
            {showProfileMenu && (
              <div className="w-[200px] absolute top-14 right-0 border-[1.3px] rounded-md border-slate-200 bg-white shadow-md">
